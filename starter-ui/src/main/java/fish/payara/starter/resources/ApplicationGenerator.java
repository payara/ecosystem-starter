...
import static fish.payara.starter.resources.ApplicationConfiguration.PAYARA_QUBE;
...
public class ApplicationGenerator {
    ...
    private static final String ARCHETYPE_VERSION = "1.0.0-beta17-SNAPSHOT";
    ...
    private Properties buildMavenProperties(ApplicationConfiguration appProperties) {
        ...
        properties.put(PAYARA_QUBE, appProperties.isQube());
