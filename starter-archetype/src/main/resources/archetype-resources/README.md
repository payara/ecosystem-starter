...
#end
#if (${docker} == 'true')
- [Docker Desktop](https://docs.docker.com/desktop/) — required to build and run Docker images. Follow the official [Docker Desktop installation guide](https://docs.docker.com/desktop/setup/install/overview/) for your operating system and make sure Docker Desktop is running before executing any Docker commands.
#end
...
Once the container starts, you can access the application at http://localhost:8080/
#else
Open a terminal and navigate to the project's root directory. Make sure you have Docker installed and running on your system.
...
Once the image is built, you can start a Docker container from the image using the following command:

```
gradle startDockerContainer
```

The container maps port 8080 by default. Once it starts, you can access the application at http://localhost:8080/
#end
